  ...
  l9.setFont(new Font("Arial",Font.PLAIN,20));
   ...
   l11.setFont(new Font("Arial",Font.PLAIN,20));
	   ...
	   l12.setFont(new Font("Arial",Font.PLAIN,20));
        ...
        b0 = new JButton("Open",new ImageIcon(getClass().getResource("/open.png")));
        b0.setBounds(150,350,110,35);b0.setToolTipText("click to open medicine details");
		b.add(b0);b0.addActionListener(this);

		b1 = new JButton("Delete",new ImageIcon(getClass().getResource("/delete.png")));
    	...
    	b3 = new JButton("All",new ImageIcon(getClass().getResource("/all.png")));//if button is press then record display repeat
