...
{   JFrame jf;
	...
	public MainMenu()
	{
		...
		mbar.add(m1);
		m1_1 = new JMenuItem("Add New Supplier",new ImageIcon(getClass().getResource("/addnew.png")));
		m1.add(m1_1);
		m1_2 = new JMenuItem("search Supplier",new ImageIcon(getClass().getResource("/search.png")));
		m1.add(m1_2);
		m1_3 = new JMenuItem("Update Supplier",new ImageIcon(getClass().getResource("/update.png")));
		m1.add(m1_3);
		m1_4 = new JMenuItem("Delete Supplier",new ImageIcon(getClass().getResource("/delete.png")));
		m1.add(m1_4);
	    m1_5 = new JMenuItem("List of Supplier",new ImageIcon(getClass().getResource("/all.png")));
		m1.add(m1_5);

		m2=new JMenu("Medicine");
		mbar.add(m2);
		m2_1 = new JMenuItem("Add New Medicine",new ImageIcon(getClass().getResource("/addnew.png")));
		m2.add(m2_1);
		m2_2 = new JMenuItem("search Medicine",new ImageIcon(getClass().getResource("/search.png")));
		m2.add(m2_2);
		m2_3 = new JMenuItem("Update Medicine",new ImageIcon(getClass().getResource("/update.png")));
		m2.add(m2_3);
		m2_4 = new JMenuItem("Delete Medicine",new ImageIcon(getClass().getResource("/delete.png")));
		m2.add(m2_4);
	    m2_5 = new JMenuItem("Stock of Medicine",new ImageIcon(getClass().getResource("/all.png")));
		m2.add(m2_5);


		m3=new JMenu("Report");
	    mbar.add(m3);
		m3_1 = new JMenuItem("Daily Purchase Report",new ImageIcon(getClass().getResource("/report.png")));
		m3.add(m3_1);

		m3_2 = new JMenuItem("Suplier wise medicine Report",new ImageIcon(getClass().getResource("/report.png")));
		m3.add(m3_2);

		m3_3 = new JMenuItem("Suplier wise medicine Report",new ImageIcon(getClass().getResource("/report.png")));
		m3.add(m3_3);

		m4=new JMenu("About");
		mbar.add(m4);
		m4_1 = new JMenuItem("About System",new ImageIcon(getClass().getResource("/help.png")));
		m4.add(m4_1);

		m5=new JMenu("Exit");
		mbar.add(m5);
		m5_1 = new JMenuItem("Exit",new ImageIcon(getClass().getResource("/exit.png")));
		m5.add(m5_1);
